...
<xsl:template match="h:span[@class='hll']" mode="m:verbatim">
  <fo:inline background-color="#ffffcc">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='c']" mode="m:verbatim">
  <!-- Comment -->
  <fo:inline color="#408080" font-style="italic">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='err']" mode="m:verbatim">
  <!-- Error -->
  <fo:inline border="1px solid #FF0000">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='k']" mode="m:verbatim">
  <!-- Keyword -->
  <fo:inline color="#008000" font-weight="inherit">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='gh']" mode="m:verbatim">
  <!-- Generic.Heading -->
  <fo:inline color="#000080" font-weight="bold">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='gp']" mode="m:verbatim">
  <!-- Generic.Prompt -->
  <fo:inline color="#000080" font-weight="inherit">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='gu']" mode="m:verbatim">
  <!-- Generic.Subheading -->
  <fo:inline color="#800080" font-weight="bold">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='nc']" mode="m:verbatim">
  <!-- Name.Class -->
  <fo:inline color="#0000FF" font-weight="inherit">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='ni']" mode="m:verbatim">
  <!-- Name.Entity -->
  <fo:inline color="#999999" font-weight="inherit">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='ne']" mode="m:verbatim">
  <!-- Name.Exception -->
  <fo:inline color="#D2413A" font-weight="inherit">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='ow']" mode="m:verbatim">
  <!-- Operator.Word -->
  <fo:inline color="#AA22FF" font-weight="inherit">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='sd']" mode="m:verbatim">
  <!-- Literal.String.Doc -->
  <fo:inline color="#BA2121" font-style="italic">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='se']" mode="m:verbatim">
  ...
  <fo:inline color="#BB6622" font-weight="inherit">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
...
<xsl:template match="h:span[@class='si']" mode="m:verbatim">
  ...
  <fo:inline color="#BB6688" font-weight="inherit">
    <xsl:apply-templates/>
  </fo:inline>
</xsl:template>
